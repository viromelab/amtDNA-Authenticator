...
import subprocess
import logging
from authpipe.general_utilities import is_number

def read_multifasta():
    global samples, this_file_path, window, N_INTERVALS
    ...
    N_INTERVALS = int(max_age/window)
...
def load_features():
    global df_train, df_val, df_test, N_INTERVALS, window
